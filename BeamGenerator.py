...
#		self.shots = int((self.expendableMod*self.beamType.shotCapacity*self.powerCell.multiplier*self.cellNum)/(self.damageDice**3))
	...
	def getAltDamageString(self):
		if "PulseDualMode" in self.keywords:
			...
			pass		# Placeholder for alt damage strings for blasters.
...
def RandomGen(InputTL):
	...
	while True:
		...
		MyBeamGun = EnergyWeapon((MyBeam.name+" "+str.casefold(MyConfiguration.name)),MyBeam.TL,MyBeam,MyFocalArray,MyRoF,MyDamageDice,MyConfiguration)
...
print("""\n==== GURPS BeamGen ====
    ...
    Part of the GURPSGen suite made by CTA. For more information see https://github.com/GURPSGen/BeamGen
