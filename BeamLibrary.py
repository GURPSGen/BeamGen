...
# Keyword definitions:
	...
	# Projector - this uses the Beam Weapons (Projector) skill.
...
## Additional Beam Types from Ultra-Tech ##
	# EMP, neural, sonic screamer and sonic stun weapons need identical E and shotCapacity but E and Bc differ between configurations and the only way to make UT-like weapons is with per-configuration E and Bc, or fiddle factors.
...
PlasmaGun = BeamType(
			...
			baseLC = 3,
			diceMult = 1.0,
			keywords = ["NotTightbeam","Superscience"]
			)
